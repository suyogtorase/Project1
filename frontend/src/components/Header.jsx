      ...
      <div className='relative flex flex-col items-center px-4 sm:px-6 text-gray-900enter w-full max-w-7xl mx-auto'>
        ...
        <div className="relative mb-8 group">
          ...
          <div className="absolute -top-4 -right-4 bg-gray-100 border border-gray-900/30 text-gray-900 p-3 rounded-xl shadow-xl animate-bounce">
            <Sparkles className="h-5 w-5 text-gray-900lue-600" />
          </div>
        </div>

        {/* Greeting */}
        <h1 className='flex items-center gap-3 text-2xl sm:text-4xl font-bold mb-4 text-gray-900 animate-in slide-in-from-bottom animation-delay-200'>
          Hello {userData ? userData.name : 'Learner'}!
          <img className='w-10 aspect-square animate-wave' src={assets.hand_wave} alt="" />
        </h1>

        {/* Main Heading */}
        <h2 className='text-4xl sm:text-gray-900xl font-bold mb-6 max-w-4xl text-gray-900 leading-tight animate-in slide-in-from-bottom animation-delay-400'>
          AI-Powered{' '}
          <span className='relative inline-block'>
            <span className='relative z-10 bg-gray-900 bg-clip-text text-transparent'>
              Adaptive Learning
            </span>
            <span className='absolute bottom-2 left-0 w-full h-3 bg-gray-900/30 -rotate-1' />
          </span>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-in slide-in-from-bottom animation-delay-800">
          <button className='group px-8 py-4 bg-gray-900 text-white rounded-xl hover:bg-black transition-all hover:shadow-xl hover:shadow-md hover:scale-105 flex items-center justify-center gap-2 font-medium'>
            Start Learning Now
            <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
          </button>
          <button className='px-8 py-4 bg-gray-100 text-gray-900 rounded-xl border-2 border-gray-300 hover:border-gray-900 hover:text-gray-900lue-600 transition-all font-medium'>
            Watch Demo
          </button>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 animate-in slide-in-from-bottom animation-delay-1000">
          <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-xl border border-gray-200">
            <div className="w-12 h-12 rounded-lg  flex items-center justify-center">
              <Users className="h-6 w-6 text-gray-900lue-600" />
            </div>
          ...
          <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-xl border border-gray-200">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Institute Partners</p>
            </div>
          </div>
        </div>
