...
const MiddleSection = () => {
  ...
  return (
    <div className="py-24 px-4 sm:px-6 bg-gray-50 w-full">
      <div className="max-w-7xl mx-auto w-full">
        
        {/* Header */}
        <div className="text-gray-900enter mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className={`group relative p-8 bg-white rounded-2xl border-2 border-gray-200 hover:border-gray-900/50 transition-all duration-300 hover:shadow-xl hover:shadow-sm cursor-pointer ${
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-gray-900lue-600 transition-colors">
                  {feature.title}
                </h3>
        ...
        {/* Bottom CTA */}
        <div className="mt-16 text-gray-900enter">
          <p className="text-gray-500 mb-6">
            Want to see how it works?
          </p>
          <button className="px-8 py-4 bg-gray-900 text-white rounded-xl hover:bg-black transition-all hover:shadow-lg hover:shadow-md hover:scale-105 font-medium inline-flex items-center gap-2">
            Explore Features
