...
const Sidebar = ({ selectedUser, setSelectedUser }) => {
    ...
    return (
        <div className={`bg-gray-100 h-full p-5 rounded-r-xl overflow-y-scroll text-gray-900 ${selectedUser ? "max-md:hidden" : ""}`}>
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-white border 
                                        border-gray-600 text-gray-900 hidden group-hover:block'>
                ...
                <div className='bg-white rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
                    ...
                    <input
                        ...
                        type="text" className='bg-transparent border-none outline-none text-gray-900 text-xs placeholder-gray-400 flex-1'
            ...
            <div className='flex flex-col gap-2'>
                {isLoading && <p className='text-xs text-gray-700 py-4 text-gray-900enter'>Loading users...</p>}
                {!isLoading && filteredUsers.length === 0 && (
                    <p className='text-xs text-gray-700 py-4 text-gray-900enter'>No users found</p>
                )}
                {filteredUsers.map((user) => {
                    ...
                    return (
                        ...
                        ${selectedUser?._id === user._id ? 'bg-white/70' : 'hover:bg-white/40'}`}>
