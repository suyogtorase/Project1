        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            <div className="relative">
              <MessageCircle className="h-8 w-8 text-gray-900lue-600 transition-transform group-hover:rotate-12" />
          ...
          <div className="hidden md:flex items-center gap-6">
            {navLinks.map((link, idx) => (
              <button
                ...
                className="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition-colors relative group font-medium"
              >
                {link.icon}
                {link.name}
            ...
            {userData ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-2 bg-gray-100 rounded-xl border border-gray-300 hover:border-gray-900 transition-all group"
                >
                  <div className="w-9 h-9 flex justify-center items-center rounded-full bg-gray-900 text-white font-bold">
                    {userData.name[0].toUpperCase()}
                  </div>
                  <div className="hidden sm:block text-left">
                    <p className="text-gray-900 font-medium text-sm">{userData.name}</p>
                    {!userData.userVerified && (
                ...
                {/* Dropdown Menu */}
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-300 rounded-xl shadow-2xl overflow-hidden animate-in slide-in-from-top">
                    {/* User Info */}
                    ...
                    <div className="py-2">
                      ...
                      {!userData.userVerified && (
                        <>
                          ...
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 text-orange-400 hover:bg-gray-100 transition-colors"
                          >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-gray-100 transition-colors"
                      >
              ...
              <button
                className="px-6 py-3 bg-gray-900 text-white rounded-xl hover:bg-black transition-all hover:shadow-lg hover:shadow-md hover:scale-105 font-medium"
                onClick={() => navigate('/login')}
              >
                Login
              </button>
            ...
            <div className="px-6 py-4 space-y-2">
              {navLinks.map((link, idx) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 py-3 text-gray-700 hover:text-gray-900 transition-colors"
                >
                  {link.icon}
                  {link.name}
                </button>
