...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-gray-900">
      {/* Header Section */}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 group-hover:text-indigo-300 transition-colors">
                        {institute.name} <span className="text-sm font-normal text-gray-500">(by {institute.administrator?.name})</span>
                      </h3>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-gray-900 font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/30 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
                  ...
                  <button
                    ...
                    disabled={processingId === institute._id}
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-gray-900 font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/30 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
