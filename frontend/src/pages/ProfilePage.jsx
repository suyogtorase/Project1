...
const ProfilePage = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-50 flex items-center justify-center px-6 py-12 relative overflow-hidden'>
            ...
            {/* Profile Card */}
            <div className='relative w-full max-w-xl bg-white border border-gray-200 rounded-2xl shadow-2xl '>
                ...
                <form onSubmit={handleSubmit} className='p-8 space-y-5'>
                    ...
                    <div className='flex flex-col items-center gap-4 pb-6 border-b border-gray-200'>
                            ...
                            <label htmlFor="avatar" className='cursor-pointer'>
                                <div className='relative'>
                                    <img
                                        ...
                                        alt="Profile"
                                        className='w-28 h-28 rounded-full object-cover border-4 border-gray-900/30 group-hover:border-gray-900 transition-all'
                                    />
                        ...
                        <div className='text-gray-900enter'>
                            ...
                            <p className='text-xs text-gray-500 mt-1'>Click to upload (Max 5MB)</p>
                        </div>
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <input
                            ...
                            className='w-full px-4 py-2.5 bg-gray-100 border-2 border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-900 transition-all text-sm'
                        />
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <textarea
                            ...
                            className='w-full px-4 py-2.5 bg-gray-100 border-2 border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-900 transition-all resize-none text-sm'
                            rows={3}
                        ></textarea>
                    </div>
                    ...
                    {userData?.role !== 'Administrator' && (
                        <div className='space-y-2'>
                            ...
                            <input
                                ...
                                type="text"
                                disabled
                                className='w-full px-4 py-2.5 bg-gray-100 border-2 border-gray-300 rounded-lg text-gray-500 cursor-not-allowed transition-all text-sm'
                            />
                        </div>
                    )}
                    ...
                    <button
                        ...
                        className='w-full py-3 bg-gray-900 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-md transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mt-6 text-sm'
                    >
                    ...
                    {userData?.role && (
                        <div className='flex justify-center pt-4'>
                            <span className='inline-flex items-center gap-2 px-4 py-2 bg-gray-100 border border-gray-900/30 rounded-full text-gray-900lue-600 text-xs font-medium'>
